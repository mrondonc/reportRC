...
class ReporteDAO implements DAO
{
     ...
     * @return ReporteDAO
     */
    public function getListByUserMax5($cod_usuario)
    {

        $sql = "SELECT * FROM REPORTE where cod_usuario= " .$cod_usuario. " order by cod_reporte desc, hora_de_registro desc limit 5;";
        $reportes = array();
        if (!$resultado = pg_query($this->conexion, $sql)) die();
