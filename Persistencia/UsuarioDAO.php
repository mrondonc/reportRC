...
class UsuarioDAO implements DAO
{
     ...
     * @return void
     */
    public function createXLogin($usuario)
    {
        $sql = "insert into USUARIO (nombre_usuario, apellido_usuario, telefono_usuario, correo_usuario, cod_mod_sap, cod_tipo_usuario, cod_estado_usuario, contraseña, usuario_login, cumpleaños) 
                                        values (
                                            '" . $usuario->getNombre_usuario() . "',
                                            '" . $usuario->getApellido_usuario() . "',
                                            " . $usuario->getTelefono_usuario() . ",
     ...
     * @return void
     */
    public function modifyXUser($usuario)
    {
     ...
     * @return UsuarioDAO
     */
    public function getListOrdenNombreEnEspera()
    {

        $sql = "SELECT * FROM USUARIO where cod_estado_usuario =4 order by nombre_usuario asc limit 5";
        $usuarios = array();
        if (!$resultado = pg_query($this->conexion, $sql)) die();
     ...
     * @return UsuarioDAO
     */
    public function getListOrdenNombreI()
    {
