...
$listSubClientes = ManejoSub_cliente_partner::getListSUFACINAActivo();

?>
<!-- FORMULARIO AGREGAR SUB CLIENTE SUCAFINA -->
<div class="row">
  <div class="col-md-12">
    <div class="card">
      <div class="card-header card-header-primary">
        <h4 class="card-title">AGREGAR CLIENTE SUCAFINA</h4>
        <p class="card-category">Verifique previamente si ya esta creado el cliente de SUFACINA</p>
      </div>
      <div class="card-body">
        <form method="post" action="ModuloAdmin/agregaClienteSuca.php">
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  <label class="bmd-label-floating">Clientes SUCAFINA Existentes</label>
              ...
              <div class="col-md-7">
                <div class="form-group">
                  <label class="bmd-label-floating">Nuevo Cliente SUCAFINA</label>
