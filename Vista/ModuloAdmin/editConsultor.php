            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  ...
                  <p class="card-category">Complete el perfil del consultor</p>
                </div>
                <div class="card-body">
                <form action="ModuloAdmin/editsConsultor.php?cod_usuario=<?php echo $usuario->getCod_usuario() ?>" method="post">
                    <div class="row">
                      <div class="col-md-5">
