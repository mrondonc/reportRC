	...
	if ($cliente_partner == 1) {
		...
		'
			<div class="row">
				...
				<div class="col-md-2">
				<a href="?menu=agregarClienteAxity" class="btn btn-primary btn-round">Agregar CLIENTE</a>
				</div>
			</div>
			<div class="row">
				<div class="col-md-12">
		...
		'
			...
			<div class="col-md-10">
				...
				<div class="col-md-2">
				<a href="?menu=agregarClienteEveris" class="btn btn-primary btn-round">Agregar CLIENTE</a>
				</div>
			</div>
			<div class="row">
				<div class="col-md-12">
		...
		<div class="row">
			<div class="col-md-10">
				...
				<div class="col-md-2">
				<a href="?menu=agregarClienteMillo" class="btn btn-primary btn-round">Agregar CLIENTE</a>
				</div>
			</div>
			<div class="row">
				<div class="col-md-12">
		...
		<div class="col-md-10">
			...
			<div class="col-md-2">
				<a href="?menu=agregarPepCliente" class="btn btn-primary btn-round">Agregar PEP</a>
			</div>
		</div>
		<div class="row">
				<div class="col-md-12">
	 ...
	 //CLIENTE ICE
		...
		'
			<div class="row">
				 ...
				 <div class="form-group">
				 <select name="clienteIce" id="clienteIce" class="form-control" required>
						 <option value="">Seleccione alguna opcion</option>';
