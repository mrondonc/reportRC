            ...
            <table class="table" style="text-align: center;">
                ...
                <tbody style="text-align: center;">
                    <tr>
                        ...
                        <td style="font-size: small;"><a href="../Vista/exportExcelAdmin2.php?cod_administrador=<?php echo $administrador->getCod_administrador(); ?>&id=7"> Descargar excel </a></td>
                    </tr>
                    <tr>
                        ...
                        <td style="font-size: small;"><a href="../Vista/exportExcelAdmin2.php?cod_administrador=<?php echo $administrador->getCod_administrador(); ?>&id=8"> Descargar excel </a></td>
                    </tr>
                    <tr>
                        ...
                        <td style="font-size: small;"><a href="../Vista/exportExcelAdmin2.php?cod_administrador=<?php echo $administrador->getCod_administrador(); ?>&id=9"> Descargar excel </a></td>
                    </tr>
                    <tr>
                        ...
                        <td style="font-size: small;"><a href="../Vista/exportExcelAdmin2.php?cod_administrador=<?php echo $administrador->getCod_administrador(); ?>&id=10"> Descargar excel </a></td>
                    </tr>
                    <tr>
                        ...
                        <td style="font-size: small;"><a href="../Vista/exportExcelAdmin2.php?cod_administrador=<?php echo $administrador->getCod_administrador(); ?>&id=11"> Descargar excel </a></td>
                    </tr>
                    <tr>
                        ...
                        <td style="font-size: small;"><a href="../Vista/exportExcelAdmin2.php?cod_administrador=<?php echo $administrador->getCod_administrador(); ?>&id=12"> Descargar excel </a></td>
                    </tr>
                    <tr>
                        ...
                        <td style="font-size: small;"><a href="../Vista/exportExcelAdmin2.php?cod_administrador=<?php echo $administrador->getCod_administrador(); ?>&id=13"> Descargar excel </a></td>
                    </tr>
                    <tr>
                        ...
                        <td style="font-size: small;"><a href="../Vista/exportExcelAdmin2.php?cod_administrador=<?php echo $administrador->getCod_administrador(); ?>&id=14"> Descargar excel </a></td>
                    </tr>
                    <tr>
                        ...
                        <td style="font-size: small;"><a href="../Vista/exportExcelAdmin2.php?cod_administrador=<?php echo $administrador->getCod_administrador(); ?>&id=15"> Descargar excel </a></td>
                    </tr>
                    <tr>
                        ...
                        <td style="font-size: small;"><a href="../Vista/exportExcelAdmin2.php?cod_administrador=<?php echo $administrador->getCod_administrador(); ?>&id=16"> Descargar excel </a></td>
                    </tr>
                    <tr>
                        ...
                        <td style="font-size: small;"><a href="../Vista/exportExcelAdmin2.php?cod_administrador=<?php echo $administrador->getCod_administrador(); ?>&id=17"> Descargar excel </a></td>
                    </tr>
                    <tr>
                        ...
                        <td style="font-size: small;"><a href="../Vista/exportExcelAdmin2.php?cod_administrador=<?php echo $administrador->getCod_administrador(); ?>&id=18"> Descargar excel </a></td>
                    </tr>
                </tbody>
            </table>
        </div>
