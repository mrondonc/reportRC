    ...
    <div class="card-header card-header-tabs card-header-primary">
        <div class="nav-tabs-navigation">
            <div class="nav-tabs-wrapper">
                <h4 class="card-title ">Listado Total de Clientes
                    <a type="button" rel="tooltip" title="Agregar Cliente" class="btn btn-primary btn-link btn-sm" href="?menu=agregarCliente"><i style="font-size:18px;" class="fas fa-plus"></i></a>
                    <form method="POST" action="../Vista/exportExcelAdmin2.php?cod_administrador=<?php echo $administrador->getCod_administrador(); ?>&id=2" enctype="multipart/form-data">
                        <!-- <a style="text-align: right;" type="submit" name="export" rel="tooltip" title="Descargar" class="btn btn-primary btn-link btn-sm"><i style="font-size:40px;" class="fas fa-file-csv"></i></a>-->
