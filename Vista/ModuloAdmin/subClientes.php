...
$subClienteIce = ManejoSub_cliente_partner::getListIce();
...
<!-- SUB CLIENTES ICE -->
<?php } else if($cod_cliente_partner==15) { ?>
    <div class="card">
    <div class="card-header card-header-tabs card-header-primary">
        <div class="nav-tabs-navigation">
            <div class="nav-tabs-wrapper">
                <h4 class="card-title ">Listado Total de Clientes Finales ICE   <a type="button" rel="tooltip" title="Agregar Sub Cliente" class="btn btn-primary btn-link btn-sm"href="?menu=agregarSubCliente&cod_cliente_partner=15"><i style="font-size:18px;" class="fas fa-plus"></i></a><!--<a style="text-align: right;" type="button" rel="tooltip" title="Descargar" class="btn btn-primary btn-link btn-sm" href="../Vista/exportExcelAdmin.php?cod_administrador=<?php echo $administrador->getCod_administrador();?>&id=5"><i style="font-size:40px;" class="fas fa-file-csv"></i></a>--></h4>
    ...
    <div class="card-body">
        ...
        <table class="table" style="text-align: center;" >
            ...
            <tbody style="text-align: center;">
            <?php for ($i=0; $i <count($subClienteIce) ; $i++) {    
                    ?>
                <tr>
                    <td style="font-size: small;"><?php echo $subClienteIce[$i]->getNombre_sub_cliente_partner();?> </td>
                    <td style="font-size: small;"><?php echo ManejoEstado_actual::consultarEstado_actual($subClienteIce[$i]->getCod_estado_actual())->getNombre_estado();?> </td>
                    <td class="td-actions text-center">
                        <a type="button" rel="tooltip" title="Editar" class="btn btn-primary btn-link btn-sm" href="?menu=editSubCliente&cod_sub_cliente_partner=<?php echo $subClienteIce[$i]->getCod_sub_cliente_partner();?>"><i class="material-icons">edit</i></a>
                        <?php if($subClienteIce[$i]->getCod_estado_actual()==1){ ?>
                            <a type="button" rel="tooltip" title="Eliminar" class="btn btn-danger btn-link btn-sm" href="ModuloAdmin/actionDelete.php?cod_sub_cliente_partner=<?php echo $subClienteIce[$i]->getCod_sub_cliente_partner();?>&action=delete&id=4"><i class="material-icons">close</i></a>
                        <?php }else if($subClienteIce[$i]->getCod_estado_actual()==2){ ?>
                            <a type="button" rel="tooltip" title="Activar" class="btn btn-primary btn-link btn-sm" href="ModuloAdmin/actionDelete.php?cod_sub_cliente_partner=<?php echo $subClienteIce[$i]->getCod_sub_cliente_partner();?>&action=Activar&id=4"><i style="font-size:18px;" class="far fa-thumbs-up"></i></a>
                        <?php }?>
                    </td>
                </tr>
                <?php }?>
