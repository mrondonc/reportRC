  ...
  <div class="col-md-12">
    <div class="card">
      <div class="card-header card-header-primary">
        ...
        <p class="card-category">Verifique previamente si ya esta creado el cliente de SUCAFINA</p>
      </div>
      <div class="card-body">
        <form method="post" action="ModuloConsultor/agregaClienteSUCAFINA.php">
            <div class="row">
              <div class="col-md-6">
