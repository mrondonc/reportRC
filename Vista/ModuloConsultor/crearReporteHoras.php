...
if($cod_cliente_partner == 1 ){
    ...
    if($fechaValidacion >= '32 00:00 PM' && $fechaValidacion <= '32 00:00 PM'  /**($fechaValidacion >= '31 06:00 PM' && $fechaValidacion <= '30 11:59 PM' ) || ($fechaValidacion >= '31 06:00 PM' && $fechaValidacion <= '31 11:59 PM' )*/){
        echo '<script>
