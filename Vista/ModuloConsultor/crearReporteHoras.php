...
}else if($cod_cliente_partner == 15){//ICE
    if(/**($fechaValidacion >= '30 06:00 PM' && $fechaValidacion <= '30 11:59 PM' ) ||*/ ($fechaValidacion >= '32 06:00 PM' && $fechaValidacion <= '32 11:59 PM' )){
        echo '<script>
        alert("NO PUEDE REGISTRAR HORAS DE ICE, COMUNICARSE CON EL ADMINISTRADOR.")
        window.location="../Consultor.php?menu=reporteHoras";
        </script>';
    }else{
        $sub_cliente_partnerAva = $_POST['clienteIce'];
        $reporte->setFecha_de_reporte($fecha_de_reporte);
        $reporte->setCod_usuario($usuario->getCod_usuario());
        $reporte->setCod_cliente_partner($cod_cliente_partner);
        $reporte->setDescripcion_actividad($descripcion_actividad);
...
}else if($cod_cliente_partner == 16){//EVEDISA
    if(/**($fechaValidacion >= '30 06:00 PM' && $fechaValidacion <= '30 11:59 PM' ) ||*/ ($fechaValidacion >= '32 06:00 PM' && $fechaValidacion <= '32 11:59 PM' )){
        echo '<script>
        alert("NO PUEDE REGISTRAR HORAS DE EVEDISA, COMUNICARSE CON EL ADMINISTRADOR.")
        window.location="../Consultor.php?menu=reporteHoras";
        </script>';
    }else{
        //$sub_cliente_partnerAva = $_POST['clienteActionByte'];
