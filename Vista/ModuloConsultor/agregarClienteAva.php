...
$listSubClientes = ManejoSub_cliente_partner::getListAVAActivo();
  ...
  <div class="col-md-12">
    <div class="card">
      <div class="card-header card-header-primary">
        <h4 class="card-title">AGREGAR CLIENTE AVA CONSULTING</h4>
        <p class="card-category">Verifique previamente si ya esta creado el cliente de AVA CONSULTING</p>
      </div>
      <div class="card-body">
        <form method="post" action="ModuloConsultor/agregaClienteAva.php">
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  <label class="bmd-label-floating">Clientes Ava Existentes</label>
              ...
              <div class="col-md-7">
                <div class="form-group">
                  <label class="bmd-label-floating">Nuevo Cliente AVA CONSULTING</label>
