...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                <form method="post" action="ModuloConsultor/copysReporte.php" name="copyReporte" id="copyReporte">
                    ...
                    <?php if($reporte->getCod_cliente_partner()==1){?>
                        ...
                        <div class="row">
                            <div class="col-md-10">
                                ...
                                <div class="form-group">
                                <input maxlength="1000" type="text" class="form-control" name="noTicket" id="noTicket" value="<?php echo $reporte->getCod_no_ticket(); ?>" required>
                                </div>
                                </div>
                                </div>
                            </div>
